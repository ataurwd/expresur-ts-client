...
const INCOME_DATA: IncomeRow[] = [
  { id: "i1", date: "2025-01-12", amount: 1200, type: "Delivery Fee", orderId: "ORD-1001", customer: "Customer A" },
  { id: "i2", date: "2025-01-11", amount: 2500, type: "Subscription", orderId: "SUB-901", customer: "Company B" },
  { id: "i3", date: "2024-12-29", amount: -50, type: "Refund", orderId: "REF-77", customer: "Customer C" },
  { id: "i4", date: "2024-12-21", amount: 900, type: "Delivery Fee", orderId: "ORD-098", customer: "Customer D" },
  { id: "i5", date: "2024-11-30", amount: 4500, type: "Subscription", orderId: "SUB-812", customer: "Company E" },
  { id: "i6", date: "2024-10-15", amount: 700, type: "Delivery Fee", orderId: "ORD-777", customer: "Customer F" },
  { id: "i7", date: "2025-01-09", amount: 350, type: "Delivery Fee", orderId: "ORD-1102", customer: "Customer G" },
  { id: "i8", date: "2024-12-05", amount: 1200, type: "Delivery Fee", orderId: "ORD-1008", customer: "Customer H" },
];
...
function monthKey(d: string) {
  const dt = new Date(d);
  return `${dt.toLocaleString(undefined, { month: "short" })}-${dt.getFullYear()}`;
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg p-4 shadow">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="pt-2">
                <button
                  onClick={() => { setFilterMonth("all"); setFilterType("all"); setSearch(""); }}
