  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#046838]/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#FA921D]/10 rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
      </div>
          ...
          <div className="p-10 lg:p-16 flex flex-col justify-center">
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="mb-10">
                <img
                  className="w-1/2"
                  // replace with your actual logo asset or import
              ...
              <form className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="px-5 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#046838]"
                  />
                  <input
                    type="text"
                    name="lastName"
                ...
                <input
                  ...
                  required
                  className="w-full px-5 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#046838]"
                />
                ...
                >
                  {React.createElement(FaCheckCircle as any, { className: 'text-xl' })}
                  Create Free Account
                </button>
              </form>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    {React.createElement(FaGoogle as any, { className: 'text-red-500' })}
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition"
                  >
                    {React.createElement(FaFacebookF as any, { className: 'text-blue-600' })}
            ...
            <div className="max-w-lg">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-5">
                  <div className="p-4 bg-[#FA921D]/20 rounded-2xl">
                    {React.createElement(FaTachometerAlt as any, { className: 'text-3xl text-[#FA921D]' })}
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-5">
                  <div className="p-4 bg-[#FA921D]/20 rounded-2xl">
                    {React.createElement(FaShieldAlt as any, { className: 'text-3xl text-[#FA921D]' })}
                  </div>
                  <div>
              ...
              <div className="mt-12 flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="w-12 h-12 rounded-full border-4 border-[#046838] bg-gray-300" />
                  ))}
                </div>
                <div>
